...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Matrix4__ = __webpack_require__(4);
...
Vector3.prototype = {
	...
	applyEuler: function () {
		...
		return function applyEuler( euler ) {
			...
			if ( quaternion === undefined ) quaternion = new __WEBPACK_IMPORTED_MODULE_2__Quaternion__["a" /* Quaternion */]();
	...
	project: function () {
		...
		return function project( camera ) {
			...
			if ( matrix === undefined ) matrix = new __WEBPACK_IMPORTED_MODULE_1__Matrix4__["a" /* Matrix4 */]();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__math_Box2_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__math_Vector3_js__ = __webpack_require__(0);
/* unused harmony reexport Box2 */
...
//-----------------------------
	setFromCenterAndSize: function () {
		...
		var v1 = new __WEBPACK_IMPORTED_MODULE_0__Vector2__["a" /* Vector2 */](); // this is what prevents removing ??????
...
Matrix4.prototype = {
	...
	extractRotation: function () {
		...
		return function extractRotation( m ) {
			...
			if ( v1 === undefined ) v1 = new __WEBPACK_IMPORTED_MODULE_1__Vector3__["a" /* Vector3 */]();
	...
	lookAt: function () {
		...
		return function lookAt( eye, target, up ) {
			...
			if ( x === undefined ) {
				...
				x = new __WEBPACK_IMPORTED_MODULE_1__Vector3__["a" /* Vector3 */]();
				y = new __WEBPACK_IMPORTED_MODULE_1__Vector3__["a" /* Vector3 */]();
				z = new __WEBPACK_IMPORTED_MODULE_1__Vector3__["a" /* Vector3 */]();
	...
	decompose: function () {
		...
		return function decompose( position, quaternion, scale ) {
			...
			if ( vector === undefined ) {
				...
				vector = new __WEBPACK_IMPORTED_MODULE_1__Vector3__["a" /* Vector3 */]();
				matrix = new Matrix4();
	...
	makePerspective: function ( fov, aspect, near, far ) {
		...
		var ymax = near * Math.tan( __WEBPACK_IMPORTED_MODULE_0__Math__["a" /* _Math */].DEG2RAD * fov * 0.5 );
		var ymin = - ymax;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return Vector2; });
/**
 * @author mrdoob / http://mrdoob.com/
 * @author philogb / http://blog.thejit.org/
 * @author egraether / http://egraether.com/
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__threejs_src_Three_Box2_Vector3_js__ = __webpack_require__(2);
/* eslint-env browser */


/* harmony default export */ exports["default"] = function(){
	const vec1 = new __WEBPACK_IMPORTED_MODULE_0__threejs_src_Three_Box2_Vector3_js__["a" /* Vector3 */](1, 0, 0);
	const vec2 = new __WEBPACK_IMPORTED_MODULE_0__threejs_src_Three_Box2_Vector3_js__["a" /* Vector3 */](0, 1, 0);
	const vec3 = new __WEBPACK_IMPORTED_MODULE_0__threejs_src_Three_Box2_Vector3_js__["a" /* Vector3 */]();
